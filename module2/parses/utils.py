...
from module2.parses.model import SpimexTradingResult
from sqlalchemy.orm import Session


def parse_spimex_xlsx(file_path, session: Session):
    ...
    df["date"] = datetime.now()  # Здесь можно заменить на дату из файла, если она есть
